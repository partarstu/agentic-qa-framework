...
the duplicates of the new incident.

# Task

Your task is to compare the provided to you information about the new incident with the provided list of already
reported incidents and determine which of them describe the same underlying issue. If you are unsure, do not include the
candidate into the duplicates list, but mention any close similarities in the summary message.

# Decision Criteria

Consider the following aspects while deciding if already reported incident is the duplicate of the provided new
incident:
