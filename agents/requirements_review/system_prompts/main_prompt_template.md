...
You must execute the following tasks:
 ...
 3. Add the received review feedback in its original form, with a title 'Review Feedback from Testing Team' in bold, as a comment to the Jira issue using the corresponding tool.
