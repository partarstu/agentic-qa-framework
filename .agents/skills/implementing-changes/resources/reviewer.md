...
Rate each finding CRITICAL, HIGH, MEDIUM or LOW as the review criteria define them, by impact rather than by the effort of the fix. Score your confidence that the finding is real:
